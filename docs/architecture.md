...
> Этот документ фиксирует high-level архитектуру.
> Источником истины по API-контрактам, логике сервисов, модели хранения и кодам ошибок являются специализированные документы в `docs/`, перечисленные в `overview.md`.
